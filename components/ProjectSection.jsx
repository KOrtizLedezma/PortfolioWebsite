...
const projectsData = [
  {
    ...
    title: "Resume-Smith",
    description:
      "Python pipeline that generates a tailored resume and cover letter from your existing data plus a target job description.",
    image: "/Images/Projects/resume_smith.png",
    tag: ["All", "Python", "LLM"],
    gitUrl: "https://github.com/KOrtizLedezma/resume-smith",
    demoUrl: null,
  },
  {
    id: 2,
    title: "Handbird",
    description:
      "A modern twist on the classic Flappy Bird game — this version lets you jump by making a fist and restart by showing a peace sign, using real-time hand gesture recognition.",
  ...
  },
  {
    ...
    title: "Retrobyte",
    description:
      "Retrobyte is a terminal-based arcade game collection written in C using the ncurses library.",
  ...
  },
  {
    ...
    description:
      "A lightweight Python-based console tool to manage Docker containers for backend development. Supports container creation from templates or GitHub repositories, full lifecycle commands, log monitoring, and environment configuration.",
  ...
  },
  {
    ...
    title: "IMDB",
    description:
      "A lightweight, thread-safe in-memory key-value store written in C++.",
  ...
  },
  {
    ...
    description:
      "A minimalist task management web app that helps users organize, schedule, and complete daily tasks with a clean, responsive interface and secure authentication.",
  ...
  },
  {
    ...
    description:
      "A simple and responsive app that suggests songs according to a word.",
  ...
  },
  {
    ...
    title: "Geoquiz",
    description:
      "GeoQuiz is an interactive platform designed to make learning geography fun and engaging through quizzes.",
  ...
  },
  {
    ...
    description:
      "A simple and responsive website to display information about The Moderator Bot.",
    image: "/Images/Projects/DiscordWebsite.png",
    tag: ["All", "JavaScript"],
  ...
  },
  {
    ...
    description:
      "Welcome to the heart of my digital journey - an immersive showcase that unveils the code powering my portfolio website.",
  ...
  },
  {
    ...
    title: "Wordle",
    description:
      "Dynamic Wordle game project featuring JavaScript with Node.js, boasting authentication, Firebase API integration.",
  ...
  },
  {
    ...
    title: "Result Sentry",
    description:
      "ResultSentry is a Python-based web scraper that fetches soccer match results for a specific team from ESPN's website and saves the data into a clean, structured json file.",
  ...
  },
  {
    ...
    description:
      'Introducing the "Random Mail Gift" mod, a delightful addition to Stardew Valley that adds an element of surprise to your daily routine. This mod is designed to bring joy to players by sending carefully curated gifts each day, tailored to your in-game luck. Say goodbye to mundane routines and hello to daily surprises that will brighten your virtual farm life',
  ...
  },
  {
    ...
    description:
      "A Stardew Valley mod that lets players lock doors to control access, using in-game data for automatic cabin assignments.",
  ...
  },
  {
    ...
    description:
      "Classic Arcade game where the player needs to avoid the incoming traffic and get the highest score possible, allows local multiplayer",
  ...
  },
  {
    ...
    description:
      "A simple and efficient To-Do List Manager using C# that allows users to organize their tasks temporarily without the need for permanent storage. This lightweight application provides a user-friendly interface.",
  ...
  },
  {
    ...
    title: "Sudoku",
    description:
      "Classic Sudoku Game, This project showcases my proficiency in Python programming, offering players a delightful experience with various difficulty levels—Easy, Medium, and Hard.",
  ...
  },
  {
    ...
    title: "Minesweeper",
    description:
      "Minesweeper, a classic game with a strategic twist, stands as a testament to my programming skills and passion for game development. In this project, implemented using C++, players embark on an adventure to uncover hidden mines on a grid while avoiding detonation.",
